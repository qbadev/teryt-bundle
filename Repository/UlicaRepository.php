...
class UlicaRepository extends EntityRepository
{
    ...
    public function getUlicaByName($name = '', $wojewodztwo = null, $powiat = null, $gmina = null, $rodzaj_gminy = null)
    {
        ...
        $qb->select('u.nazwa_1, u.nazwa_2, u.cecha')
                ->distinct()
                ->from('QbadevTerytBundle:Ulica', 'u')
    ...
    {
      $this->_em->getConnection()->exec('UPDATE teryt_ulice u
            SET  miejscowosc_id = (
            SELECT  id
            FROM  teryt_miejscowosci m
            WHERE u.WOJ = m.WOJ AND u.POW = m.POW AND u.GMI = m.GMI AND u.RODZ_GMI = m.RODZ_GMI AND m.SYM = u.SYM)');
    }
}
